        ...
        <div style={styles.card}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 20 }}>
            {[[ClipboardList, "22 Questions", "10 health sections"], [Timer, "~5 minutes", "Quick & easy"], [Target, "Personalised", "Actionable results"]].map(([Icon, t, s]) => (
              <div key={t} style={{ textAlign: "center", padding: "16px 8px", background: BRAND_LIGHT, borderRadius: 12 }}>
        ...
        <div style={styles.card}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div>
              ...
              <input style={styles.inputField} placeholder="Your name" value={basics.name} onChange={e => handleBasicChange("name", e.target.value)} />
            </div>
            <div>
              <label style={styles.label}>Age *</label>
              <input style={styles.inputField} type="number" placeholder="Years" value={basics.age} onChange={e => handleBasicChange("age", e.target.value)} />
            </div>
            <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 4 }}>
            <div>
              ...
              <input style={styles.inputField} placeholder="e.g. Teacher" value={basics.occupation} onChange={e => handleBasicChange("occupation", e.target.value)} />
            </div>
            <div>
              <label style={styles.label}>Community</label>
              <input style={styles.inputField} placeholder="e.g. Gujarati" value={basics.community} onChange={e => handleBasicChange("community", e.target.value)} />
            </div>
          </div>
  ...
  if (step === "results" && results) {
    ...
    return (
      <div style={styles.wrap} ref={topRef}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          <button style={{ ...styles.btnPrimary, padding: "16px" }} onClick={() => alert("Book a consultation — connect this to your booking system!")}>
            <Calendar size={18} strokeWidth={2.2} aria-hidden="true" />
            <span>Book Consultation</span>
          </button>
          <button style={{ ...styles.btnSecondary, padding: "16px", flex: "none" }} onClick={() => alert("Download meal plan — connect this to your plan generator!")}>
